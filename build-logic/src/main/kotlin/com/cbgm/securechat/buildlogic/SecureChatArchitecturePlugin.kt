...
import com.cbgm.securechat.buildlogic.architecture.discovery.discoverArchitectureModules
import com.cbgm.securechat.buildlogic.architecture.serialization.ArchitectureModuleCodec
import com.cbgm.securechat.buildlogic.architecture.task.GenerateArchitectureReportTask
import com.cbgm.securechat.buildlogic.architecture.task.ValidateArchitectureTask
import com.cbgm.securechat.buildlogic.architecture.task.VerifyArchitectureReportTask
import org.gradle.api.Plugin
import org.gradle.api.Project
import org.gradle.kotlin.dsl.register

class SecureChatArchitecturePlugin : Plugin<Project> {

    override fun apply(target: Project) {
        with(target) {
            require(this == rootProject) {
                buildString {
                    append("Plugin 'securechat.architecture' ")
