...
import com.cbgm.securechat.buildlogic.quality.InstallGitHooksTask
import com.cbgm.securechat.buildlogic.quality.SetupProjectTask
...
class SecureChatQualityPlugin : Plugin<Project> {

    override fun apply(target: Project) = with(target) {
        require(this == rootProject) {
            "Plugin 'securechat.quality' must only be applied to the root project."
        }
    ...
    private fun Project.registerSetupTask(
        ...
        tasks.register<SetupProjectTask>(
            ...
            group = SETUP_TASK_GROUP
            description = "Performs the initial SecureChat project setup."
