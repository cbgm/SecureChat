...
sealed interface RelayRoutingResult {
    data object Accepted : RelayRoutingResult
...
interface RelayEnvelopeRouter {
    suspend fun accept(envelope: RelayEnvelope): RelayRoutingResult

    suspend fun deliverPending(recipientId: String): Boolean
}
