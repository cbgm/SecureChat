                    ...
                    when (frame) {
                        ...
                        is Frame.Close -> {
                            ...
                            sendError(
                                ...
                                message =
                                    "Relay protocol requires text frames"
                            )
                        }
                    }
                }
            ...
            is RelayClientMessage.SendEnvelope -> {
                ...
                if (connection == null) {
                    sendError(
                        ...
                        message =
                            "Register before sending envelopes"
                    )
    ...
    private suspend fun handleRegistration(
        ...
        if (currentConnection != null) {
            sendError(
                ...
                message =
                    "This WebSocket is already registered"
            )
    ...
    private suspend fun handleEnvelope(
        ...
        if (
            ...
            sendError(
                ...
                message =
                    "Envelope sender does not match the registered relay ID"
            )
