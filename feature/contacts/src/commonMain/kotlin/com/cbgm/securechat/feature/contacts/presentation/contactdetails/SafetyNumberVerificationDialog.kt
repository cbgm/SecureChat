    ...
    AlertDialog(
        ...
        text = {
            Column {
                Text(
                    text =
                        "Compare the complete safety number with $contactName through a trusted phone or video call.",
                    style =
                ...
                Text(
                    text =
                        "Both devices must display exactly the same number.",
                    style =
                        MaterialTheme.typography.bodyMedium
                )
                ...
                Row(
                    ...
                    Text(
                        text =
                            "We compared the entire safety number through a trusted channel, and it matched.",
                        modifier =
                            Modifier.weight(1f),
                        style =
                            MaterialTheme
