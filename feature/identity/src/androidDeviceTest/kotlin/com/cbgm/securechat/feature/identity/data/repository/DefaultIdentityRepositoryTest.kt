...
class DefaultIdentityRepositoryTest {
    ...
    @Test
    fun identityCanBeCreatedStoredAndLoaded(): Unit = runBlocking {
         ...
         */
        val privateKeyStorage = AndroidPrivateKeyStorage(
            context = context
        )

        val publicIdentityStorage = AndroidPublicIdentityStorage(
            context = context
        )
        ...
        try {
             ...
             * No fake storage.
             */
            val repository = DefaultIdentityRepository(
             ...
             */
            val existsBeforeCreation = repository
                .hasIdentity()
                .getOrThrow()
             ...
             */
            val createdIdentity = repository
                .createIdentity()
                .getOrThrow()
             ...
             */
            val existsAfterCreation = repository
                .hasIdentity()
                .getOrThrow()
             ...
             */
            val loadedEncryptionPrivateKey = privateKeyStorage
                .loadEncryptionPrivateKey()
                .getOrThrow()

            val loadedSigningPrivateKey = privateKeyStorage
    ...
    @OptIn(ExperimentalUnsignedTypes::class)
    @Test
    fun creatingIdentityTwiceDoesNotReplaceExistingIdentity() = runBlocking {
        ...
        try {
             ...
             */
            val firstEncryptionPrivateKey = privateKeyStorage
                .loadEncryptionPrivateKey()
                .getOrThrow()
                ?.copyOf()

            val firstSigningPrivateKey = privateKeyStorage
                .loadSigningPrivateKey()
                .getOrThrow()
                ?.copyOf()
             ...
             */
            val secondCreationResult = repository
                .createIdentity()
             ...
             */
            val identityAfterSecondAttempt = repository
                .getIdentity()
                .getOrThrow()
